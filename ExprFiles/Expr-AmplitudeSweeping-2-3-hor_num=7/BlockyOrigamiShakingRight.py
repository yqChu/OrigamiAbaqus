...
for part_id in range(x_num*y_num*20+x_num*10):
    if np.mod(part_id+1, 5)!=0:
        ...
        exec("nodes{flag} = n.getSequenceFromMask(mask=('[#7f]', ), )".format(flag=flag+1))
        flag += 1
...
if hor_num==4:
    ...
    nodes1 = n1.getSequenceFromMask(mask=('[#20820820 #8 ]', ), )
    nodes2 = n2.getSequenceFromMask(mask=('[#20820820 #8 ]', ), )
    nodes3 = n3.getSequenceFromMask(mask=('[#20820820 #8 ]', ), )
    nodes4 = n4.getSequenceFromMask(mask=('[#20820820 #8 ]', ), )
    nodes5 = n5.getSequenceFromMask(mask=('[#20820820 #8 ]', ), )
    nodes6 = n6.getSequenceFromMask(mask=('[#20820820 #8 ]', ), )
    nodes7 = n7.getSequenceFromMask(mask=('[#20820820 #8 ]', ), )
    nodes8 = n8.getSequenceFromMask(mask=('[#20820820 #8 ]', ), )
elif hor_num==7:
    nodes1 = n1.getSequenceFromMask(mask=('[#8102040 #10204 ]', ), )
    nodes2 = n2.getSequenceFromMask(mask=('[#8102040 #10204 ]', ), )
    nodes3 = n3.getSequenceFromMask(mask=('[#8102040 #10204 ]', ), )
    nodes4 = n4.getSequenceFromMask(mask=('[#8102040 #10204 ]', ), )
    nodes5 = n5.getSequenceFromMask(mask=('[#8102040 #10204 ]', ), )
    nodes6 = n6.getSequenceFromMask(mask=('[#8102040 #10204 ]', ), )
    nodes7 = n7.getSequenceFromMask(mask=('[#8102040 #10204 ]', ), )
    nodes8 = n8.getSequenceFromMask(mask=('[#8102040 #10204 ]', ), )    
region = a.Set(nodes=nodes1+nodes2+nodes3+nodes4+nodes5+nodes6+nodes7+nodes8, name='SideNodes')
...
if hor_num==4:
    ...
    nodes1 = n1.getSequenceFromMask(mask=('[#8102040 #10204 ]', ), )
    nodes2 = n2.getSequenceFromMask(mask=('[#8102040 #10204 ]', ), )
a.Set(nodes=nodes1+nodes2, name='LeftNodes')
...
if hor_num==4:
    nodes1 = n1.getSequenceFromMask(mask=('[#111111 ]', ), )
    ...
    nodes1 = n1.getSequenceFromMask(mask=('[#41041041 ]', ), )
    nodes2 = n2.getSequenceFromMask(mask=('[#41041041 ]', ), )
elif hor_num==7:
    nodes1 = n1.getSequenceFromMask(mask=('[#10204081 #408 ]', ), )
    nodes2 = n2.getSequenceFromMask(mask=('[#10204081 #408 ]', ), )
load_region=a.Set(nodes=nodes1+nodes2, name='RightNodes')
...
mdb.models['Model-1'].historyOutputRequests['LeftNodes'].setValues(variables=(
    'U2', 'V2'), numIntervals=10000, region=regionDef, sectionPoints=DEFAULT, 
    rebar=EXCLUDE)
...
mdb.models['Model-1'].HistoryOutputRequest(name='RightNodes', 
    createStepName='Step-1', variables=('CF2', ), numIntervals=10000, 
...
# Define Job
    job = mdb.Job(name='RightLoadFreq=200Amp={force_id}hor_num={hor_num}'.format(force_id=force_id+1, hor_num=hor_num), model='Model-1', description='', type=ANALYSIS, 
